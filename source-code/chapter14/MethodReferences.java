// Java 25+
// Feature shown: method references in stream pipelines, final in Java 8+
...
public class MethodReferences {
    ...
    void main() {
        ...
        List<Order> orders = List.of(
            ...
            new Order(2L, "south", 120.5, 1, "PENDING"),
            new Order(3L, "east",  310.9, 5, "CONFIRMED"),
            new Order(4L, "north", 99.0,  2, "CANCELLED"),
            new Order(5L, "west",  175.0, 4, "CONFIRMED")
        );
        ...
        // Lambda preferred for compound logic — method ref cannot express this
        ...
        // Rounded amounts: [200, 121, 311, 99, 175]
    }
}