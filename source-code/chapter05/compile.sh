...
mkdir -p out
javac \
  --module-source-path "com.domain.order.api=source-code\chapter05\modules\order-api\src\main\java;com.domain.order.impl=source-code\chapter05\modules\order-impl\src\main\java;com.domain.billing=source-code\chapter05\modules\billing\src\main\java;com.domain.payment.api=source-code\chapter05\modules\payment-api\src\main\java;com.domain.payment.stripe=source-code\chapter05\modules\payment-stripe\src\main\java;com.domain.app=source-code\chapter05\modules\app\src\main\java" \
  -d out \
  ...
  modules/order-impl/src/main/java/com/domain/order/impl/OrderValidator.java \
  ...
  modules/payment-api/src/main/java/com/domain/payment/api/PaymentRequest.java \
  modules/payment-api/src/main/java/com/domain/payment/api/PaymentResult.java \
