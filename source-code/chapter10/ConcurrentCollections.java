...
public class ConcurrentCollections {
    ...
    void main() throws InterruptedException {
        ...
        // ConcurrentHashMap — segments the map internally to reduce contention
        ...
        // LinkedBlockingQueue — bounded producer-consumer queue
        ...
        consumer.submit(() -> {
            try {
                for (int i = 0; i < 5; i++) {
                    String event = eventQueue.take(); // blocks until item available
