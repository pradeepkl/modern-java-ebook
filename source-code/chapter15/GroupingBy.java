// Java 25+
// Feature shown: Collectors.groupingBy with downstream collectors, final in Java 8+
...
public class GroupingBy {
    ...
    static List<Order> sampleOrders() {
        return List.of(
            ...
            new Order("ORD-002", "C2",  99.99, "PENDING",   "US"),
    ...
    void main() {
        ...
        // Computed key — bucket by amount range
        ...
        // byRegion keys: [UK, US, EU]
        // byAmountBucket keys: [STANDARD]
        // countByStatus: {CONFIRMED=3, PENDING=1, CANCELLED=1}
        // revenueByRegion: {UK=449.97, US=399.98, EU=199.99}
        // avgByRegion: {UK=224.985, US=199.99, EU=199.99}
