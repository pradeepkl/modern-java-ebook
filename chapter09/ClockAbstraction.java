...
public class ClockAbstraction {
    ...
    void main() {
        ...
        // Always true — Jun 18 is within Jan 1 to Dec 31
        log.info("Active (fixed clock 2024-06-18): " + active);

        boolean expiresSoon = sub.expiresWithinDays(30, fixedClock);
        // Always false — Dec 31 is more than 30 days from Jun 18
        log.info("Expires within 30 days (fixed clock): " + expiresSoon);

        boolean expiresInSixMonths = sub.expiresWithinDays(200, fixedClock);
        // True — Dec 31 is within 200 days of Jun 18
        log.info("Expires within 200 days (fixed clock): " + expiresInSixMonths);

        // Output:
        // Active (production clock): false
        // Active (fixed clock 2024-06-18): true
        // Expires within 30 days (fixed clock): false
        // Expires within 200 days (fixed clock): true
    }
}