...
public class PipelineReadability {
    ...
    void main() {
        List<Order> orders = List.of(
            ...
            new Order("O6", "C5", "CONFIRMED", "UK", 680.0),
            new Order("O7", "C2", "CONFIRMED", "UK", 210.0),
            new Order("O8", "C6", "CONFIRMED", "UK", 830.0)
        );

        // Readable pipeline — each line is one business step
        ...
        // When a pipeline becomes too long — extract named steps
        ...
        // Output:
        // Top customer IDs (single pipeline): [C6, C1, C5, C2]
        // Top customer IDs (split pipeline):  [C6, C1, C5, C2]
    }
}