 ...
 *               including String-to-String, type change, field extraction,
 *               and chained map with filter.
...
public class MapOperator {
    ...
    static List<Order> getOrders() {
        return List.of(
            ...
            new Order("O5", "north", 150.00, "CANCELLED")
        );
    }
    ...
    void main() {
        ...
        // Order -> Double: extract a single numeric field
        List<Double> amounts = orders.stream()
                .map(Order::amount)
                .toList();
        LOG.info("Amounts: " + amounts);

        // Chained filter + map + map: confirmed orders as formatted strings
        ...
        // Amounts: [820.0, 450.0, 610.0, 390.0, 150.0]
