 ...
 * Demonstrates: Core collector vocabulary: toList(), toSet(),
 *               toUnmodifiableList(), joining(), and counting()
...
public class CollectorBasics {
    ...
    void main() {
        ...
        // Collectors.joining — concatenate strings (SQL: STRING_AGG)
        ...
        // Collectors.counting() — SQL: SELECT COUNT(*)
        ...
        // Output:
        // Confirmed orders: 2
        // Distinct regions: [NORTH, SOUTH, EAST]  (order may vary)
        // High-value orders: 2
        // Order IDs: ORD-001, ORD-002, ORD-003, ORD-004
        // Formatted: [ORD-001, ORD-002, ORD-003, ORD-004]
        // Confirmed count: 2
    }
}