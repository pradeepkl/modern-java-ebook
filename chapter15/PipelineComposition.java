...
public class PipelineComposition {
    ...
    // Multi-level transformation: raw orders -> regional report
    ...
    void main() {
        ...
        // Log each region's aggregated metrics
        report.forEach(r ->
                log.info(r.region()
                        + " | count=" + r.count()
                        + " | total=" + r.total()
