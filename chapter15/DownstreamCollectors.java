...
public class DownstreamCollectors {
    ...
    void main() {
        List<Order> orders = List.of(
            ...
            new Order("ORD-002", "US", 320.0),
            new Order("ORD-003", "UK", 275.0),
            new Order("ORD-004", "EU", 90.0)
        );
        ...
        // Preserves all group keys even if filtered group is empty
        ...
        // Output:
        // Count per region: {UK=2, US=1, EU=1}
        // Sum per region: {UK=425.0, US=320.0, EU=90.0}
        // Avg per region: {UK=212.5, US=320.0, EU=90.0}
        // IDs by region: {UK=[ORD-001, ORD-003], US=[ORD-002], EU=[ORD-004]}
        // High-value by region: {UK=[Order[ORD-003,UK,275.0]], US=[Order[ORD-002,US,320.0]], EU=[]}
        // UK stats — count=2, total=425.0
    }
}