 ...
 * Demonstrates: imperative loop-based filtering versus intent-oriented Stream pipeline
...
public class ImperativeVsDeclarative {
    ...
    // Simple record representing an application user
    ...
    void main() {
        ...
        for (User user : users) {
            if (user.active()) {                      // condition buried in loop body
        ...
        List<String> intentEmails = users.stream()
                ...
                .map(User::email)       // extract email address
