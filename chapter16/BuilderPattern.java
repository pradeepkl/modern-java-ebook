// Java 25+
// Feature shown: Builder pattern via records and compact constructors, final in Java 16+

/**
 * Listing 16.3 — BuilderPattern.java
 * Demonstrates: Builder pattern using records with compact constructors for
 * simple validated objects, and a fluent builder class for complex optional config.
